...
def test_parse_version():
    ...
    assert utils.parse_version('0.3rc1') == (0, 3, 0, None)
    assert utils.parse_version('0.3.post1') == (0, 3, 0, None)
...
def test_version_greater_or_equal():
    ...
    assert utils.version_greater_or_equal('0.3rc1', '0.1.dev8') == True
    assert utils.version_greater_or_equal('0.3rc1', '0.3.dev4') == True
    assert utils.version_greater_or_equal('0.3rc1', '0.3') == False
    assert utils.version_greater_or_equal('0.3', '0.3rc1') == True
    assert utils.version_greater_or_equal('0.2', '0.2.1.dev5') == False
    assert utils.version_greater_or_equal('0.2.1.dev5', '0.2.1rc1') == False
    assert utils.version_greater_or_equal('0.2.1rc1', '0.2.1') == False
