...
- Add [tests](https://github.com/UDST/urbansim_templates/tree/dev/tests) if possible!

- Open a pull request to the `UDST/urbansim_templates` dev branch, including a writeup of your changes -- take a look at some of the closed PR's for examples
...
- Open a pull request to the dev branch to finalize it
...
- Check https://pypi.org/project/urbansim_templates/ for the new version
