...
class Table():
    ...
    def validate(self):
        """
        Check some basic expectations about the data generated by the step:
        
        - Confirm that the table includes a unique index column (primary key) or set of 
          columns (composite key). If not, raise a ValueError.
