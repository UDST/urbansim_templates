...
Below are some strategies we've come up with for the templates. Technical contribution guidelines are in the `Github repo <https://github.com/UDST/urbansim_templates/blob/main/CONTRIBUTING.md>`__.
